...
const dialogsBotComponent_1 = require("./dialogsBotComponent");
/**
...
class DialogsComponentRegistration extends botbuilder_core_1.ComponentRegistration {
    ...
    constructor() {
        ...
        new dialogsBotComponent_1.DialogsBotComponent().configureServices(this.services, botbuilder_dialogs_adaptive_runtime_core_1.noOpConfiguration);
    }
    /**
