...
class ManagedIdentityServiceClientCredentialsFactory extends serviceClientCredentialsFactory_1.ServiceClientCredentialsFactory {
    ...
    constructor(appId, tokenProviderFactory) {
        super();
        assert_1.ok(appId === null || appId === void 0 ? void 0 : appId.trim(), 'ManagedIdentityServiceClientCredentialsFactory.constructor(): missing appId.');
        assert_1.ok(tokenProviderFactory, 'ManagedIdentityServiceClientCredentialsFactory.constructor(): missing tokenProviderFactory.');
        this.appId = appId;
    ...
    createCredentials(appId, audience) {
        return __awaiter(this, void 0, void 0, function* () {
            assert_1.ok(yield this.isValidAppId(appId), 'ManagedIdentityServiceClientCredentialsFactory.createCredentials(): Invalid Managed ID.');
