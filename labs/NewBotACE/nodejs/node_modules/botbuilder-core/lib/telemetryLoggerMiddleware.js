        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (activity) {
                ...
                if (this.logPersonalInformation) {
                    const fromName = (_p = (_o = activity.from) === null || _o === void 0 ? void 0 : _o.name) === null || _p === void 0 ? void 0 : _p.trim();
                    if (fromName) {
                        properties[telemetryConstants_1.TelemetryConstants.fromNameProperty] = fromName;
                    }
                    const activityText = (_q = activity.text) === null || _q === void 0 ? void 0 : _q.trim();
                    if (activityText) {
                        properties[telemetryConstants_1.TelemetryConstants.textProperty] = activityText;
                    }
                    const activitySpeak = (_r = activity.speak) === null || _r === void 0 ? void 0 : _r.trim();
                    if (activitySpeak) {
    ...
    fillSendEventProperties(activity, telemetryProperties) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (activity) {
                ...
                // Use the LogPersonalInformation flag to toggle logging PII data, text and user name are common examples
                if (this.logPersonalInformation) {
                    const recipientName = (_l = (_k = activity.recipient) === null || _k === void 0 ? void 0 : _k.name) === null || _l === void 0 ? void 0 : _l.trim();
                    if (recipientName) {
                        properties[telemetryConstants_1.TelemetryConstants.recipientNameProperty] = recipientName;
                    }
                    const activityText = (_m = activity.text) === null || _m === void 0 ? void 0 : _m.trim();
                    if (activityText) {
                        properties[telemetryConstants_1.TelemetryConstants.textProperty] = activityText;
                    }
                    const activitySpeak = (_o = activity.speak) === null || _o === void 0 ? void 0 : _o.trim();
                    if (activitySpeak) {
                        properties[telemetryConstants_1.TelemetryConstants.speakProperty] = activitySpeak;
                    }
                    if ((_p = activity.attachments) === null || _p === void 0 ? void 0 : _p.length) {
    ...
    fillUpdateEventProperties(activity, telemetryProperties) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (activity) {
                ...
                if (this.logPersonalInformation) {
                    const activityText = (_j = activity.text) === null || _j === void 0 ? void 0 : _j.trim();
                    if (activityText) {
                        properties[telemetryConstants_1.TelemetryConstants.textProperty] = activityText;
                    }
                }
